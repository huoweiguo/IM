<template>
  <div class="grouping">
    <div class="tab-title">分组</div>
    <div class="list-container">
      <div v-for="group in groupingList" :key="group.id" class="group">
...
// 假设存在获取分组列表的API，此处使用占位符
import { getGroupingList } from '@/api/index.js';

const groupingList = ref([]);

const loadGroupingList = () => {
  getGroupingList().then((res) => {

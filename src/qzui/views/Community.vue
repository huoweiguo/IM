        ...
        <div class="community-container">
            <aside class="sidebar">
                        ...
                        <template #dropdown>
                            <el-dropdown-menu>
                                ...
                                <el-dropdown-item @click="openScanWindow">
                                    <el-icon><StarFilled /></el-icon>关注我
                                </el-dropdown-item>
                ...
                <nav class="community-nav">
                    <ul>
                        <li v-for="community in filteredList" :key="community.id" :class="{ active: activeId === community.id }" @click="selectCommunity(community.id)">

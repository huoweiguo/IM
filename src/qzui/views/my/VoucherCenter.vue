<template>
    <div class="voucher-center">
        ...
        <!-- 充值金额 -->
        <div class="section-title">充值圈币</div>

        <div class="amount-list">
            <div v-for="(item, idx) in amountOptions" :key="item.value" :class="['amount-item', { selected: selectedAmount === idx }]" @click="selectedAmount = idx">
        ...
        <div class="pay-list">
            <div v-for="(pay, idx) in payOptions" :key="pay.value" :class="['pay-item', { selected: selectedPay === idx }]" @click="selectedPay = idx">
                <div>
        ...
        <div class="pay-bar">
            <div class="pay-bar-main">
                <div class="pay-bar-info">
                    <span class="pay-bar-amount"><i>支付</i>{{ amountOptions[selectedAmount].newPrice }}<i>元</i>,购买{{ amountOptions[selectedAmount].value }}圈币</span>
                    <span class="pay-bar-tip">首次{{ amountOptions[selectedAmount].newPrice }}元，后续每次需{{ amountOptions[selectedAmount].oldPrice }}元</span>
                </div>

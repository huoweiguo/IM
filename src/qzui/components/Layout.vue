<template>
    <ElectronWindowsControlButtonView style="position: absolute; top: 0; right: 0; z-index: 999999" :maximizable="false" v-if="store.state?.misc?.isElectronWindowsOrLinux" />
    <div class="layout">

<template>
    <div class="streaming-text-message-container" v-bind:class="{ out: message.direction === 0 }">
...
.streaming-text-message-container :deep(p) {
    user-select: text;
    white-space: pre-line;
}

.streaming-text-message-container :deep(.loading) {
    margin: 5px 0 0;
}

.streaming-text-message-container :deep(code) {
    background: #f5f5f5;
...
/*style for v-html */
.streaming-text-message-container .text :deep(img) {
    max-width: 400px !important;
    display: inline-block;
}

.streaming-text-message-container .text :deep(a) {
    white-space: normal;
}

.streaming-text-message-container .text :deep(.emoji) {

<template>
    <div class="composite-message-container" @click="showCompositePage" v-bind:class="{ out: message.direction === 0 }">
...
.composite-message-container .content :deep(img) {
    max-width: 400px !important;
    display: inline-block;
}

.composite-message-container .content :deep(a) {
    white-space: normal;
}

.composite-message-container .content :deep(.emoji) {

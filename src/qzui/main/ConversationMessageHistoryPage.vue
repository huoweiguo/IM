    ...
    <section>
        <div v-if="conversationInfo" class="conversation-message-history-page">
            ...
            <div class="search-input-container">
                <input id="searchInput" ref="input" autocomplete="off" v-model.trim="query" @keydown.esc="cancel" type="text" :placeholder="$t('common.search')" />
                <i class="icon-ion-ios-search"></i>
            </div>
            <div class="category-container">
                <div class="category-item" v-bind:class="{ active: category === 'all' }" @click="setCurrentCategory('all')">全部</div>
                <div class="category-item" v-bind:class="{ active: category === 'file' }" @click="setCurrentCategory('file')">文件</div>
                <div class="category-item" v-bind:class="{ active: category === 'media' }" @click="setCurrentCategory('media')">图片与视频</div>
                <div class="category-item" v-bind:class="{ active: category === 'link' }" @click="setCurrentCategory('link')">链接</div>
            </div>
            ...
            <div ref="conversationMessageList" class="message-list-container" infinite-wrapper>
                <infinite-loading ref="infiniteLoader" :identifier="'historyMessageLoader-' + category" force-use-infinite-wrapper direction="top" @infinite="infiniteHandler">

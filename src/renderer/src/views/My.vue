<template>
  <div class="my-container">
    <div class="my-page" v-infinite-scroll="load" style="overflow: auto;">
      ...
      <div class="my-page__watch">
        <div class="my-page__watch_switch">
          观看提醒
          <el-switch v-model="watchSwitch" size="small" style="margin-left: 5px;" active-color="#13ce66"
            inactive-color="#ffffff" inline-prompt />
        </div>

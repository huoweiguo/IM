<template>
    <div id="app-main" style="width: 100vw; height: 100vh" @contextmenu.prevent="" @dragenter="$event.preventDefault()"
        @dragover="$event.preventDefault()" @drop="$event.preventDefault()" v-visibility-change="visibilityChange">
        <div v-if="!sharedMiscState.isElectron" id="blur-container" class="blur-container">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100%" id="blurred_mkvvpnf50"
                ...
                <image x="0" y="0" width="100%" height="100%" externalResourcesRequired="true"
                    ...
                    xlink:href="https://static.wildfirechat.net/web_wfc_bg2.jpeg" style="filter: url(#blur_mkvvpnf)"
        ...
        <CoolLightBox v-if="!sharedMiscState.isElectron" :items="sharedConversationState.previewMediaItems"
            :index="sharedConversationState.previewMediaIndex" :slideshow="false"
